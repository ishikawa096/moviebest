...
export const moviesMock: Array<Movie> = [
  movieMock,
  { ...movieMock, id: 2, title: 'MOVIE2' },
  { ...movieMock, id: 3, title: 'MOVIE3' },
  { ...movieMock, id: 4, title: 'MOVIE4' },
  { ...movieMock, id: 5, title: 'MOVIE5' },
]
...
export const userEditMock: UserEditParams = { name: 'NAME', email: 'test@example.com', currentPassword: '' }
