...
const About = () => (
  <div className='relative py-5 px-10 md:px-28 lg:px-40 w-screen flex flex-col text-center items-center bg-yellow-400 text-gray-700'>
    ...
    <div className='p-8 mb-10 bg-white w-full flex-col flex gap-3 rounded-lg'>
      ...
      <div>作ったベストはツイートボタンでツイートできます</div>
    </div>
    <div className='p-8 mb-10 bg-white w-full flex-col flex gap-3 rounded-lg'>
      <div className='rounded-lg overflow-hidden'>
